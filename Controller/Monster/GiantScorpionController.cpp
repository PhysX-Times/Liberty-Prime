...
#include "GiantScorpionController.h"
#include "Components/CapsuleComponent.h"
#include "BehaviorTree/BehaviorTree.h"
#include "BehaviorTree/BehaviorTreeComponent.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "BehaviorTree/Blackboard/BlackboardKeyAllTypes.h"
#include "Monster/GiantScorpion.h"

AGiantScorpionController::AGiantScorpionController()
{
	NormalAttackMax = 3;
	NormalAttackMin = 1;
...
void AGiantScorpionController::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

	AGiantScorpion* MyPawn = Cast<AGiantScorpion>(GetPawn());

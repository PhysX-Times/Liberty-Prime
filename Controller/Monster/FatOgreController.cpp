...
#include "Monster/FatOgre.h"

AFatOgreController::AFatOgreController()
{
...
void AFatOgreController::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

	AFatOgre* MyPawn = Cast<AFatOgre>(GetPawn());
	...
	if (MyPawn)
	{
		...
		if (IsTarget && !IsTarget->IsDead && MyPawn->CheckRestriction())
		{
			...
			if (Distance <= MyPawn->AttackDistance_Roar && MediumRangeAttackCurrent < MediumRangeAttackTarget)
			{
				MyPawn->Roar();

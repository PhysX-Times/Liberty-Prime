...
#include "PlantMonsterController.h"
#include "Components/CapsuleComponent.h"
#include "BehaviorTree/BehaviorTree.h"
#include "BehaviorTree/BehaviorTreeComponent.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "BehaviorTree/Blackboard/BlackboardKeyAllTypes.h"
#include "Monster/PlantMonster.h"

APlantMonsterController::APlantMonsterController()
{
...
void APlantMonsterController::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

	APlantMonster* MyPawn = Cast<APlantMonster>(GetPawn());
	...
	if (MyPawn)
	{
		...
		if (IsTarget && !IsTarget->IsDead && MyPawn->CheckRestriction())
		{
			...
			if (Distance> MyPawn->AttackDistance && Distance >= MyPawn->AttackDistance_Magic_Min && Distance <= MyPawn->AttackDistance_Magic_Max && MediumRangeAttackCurrent < MediumRangeAttackTarget)
			{
				MyPawn->HomingTarget = IsTarget;
				MyPawn->MagicAttack();
